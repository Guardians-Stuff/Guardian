...
module.exports = {
    ...
    options: [
        ...
        {
            name: 'remove',
            description: "Removes a warn to a member",
            type: 3,
            options: [
                {
                    name: "warn-id",
                    description: "Enter the warn ID",
                    type: 6,
                    required: true
                },
            ],
        ...
        {
            name: 'list',
            description: "Displays the list of warns a member has",
            type: 1,
            options: [
                {
                    name: "user",
    ...
    async execute(interaction, client) {
        ...
        switch (options.getSubcommand()) {
            ...
            case "add": {
                ...
                if (Target.id === user.id) return Reply(interaction, "❌", `You can't warn yourself!`)
                if (guild.ownerId === Target.id) return Reply(interaction, "❌", `You can't warn the server owner!`)
            ...
            case "remove": {
                ...
                if (!Data) return EditReply(interaction, "❌", `The ID you provided is not valid!`)
            ...
            case "list": {
                ...
                if (UserWarns.length === 0) return EditReply(interaction, "❌", `Member doesn't have any warnings!`)

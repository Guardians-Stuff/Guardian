...
module.exports = {
    data: new Discord.SlashCommandSubcommandBuilder()
        ...
        .addStringOption(option => option
            ...
            .setName('description')
            .setDescription('Description to be used in the embed')
    ...
    async execute(interaction, client, dbGuild) {
        ...
        await client.expiringDocumentsManager.giveaways.addNewDocument(await Giveaways.create({
            giveaway: sent.id,
        ...
        return { embeds: [ EmbedGenerator.basicEmbed(`Giveaway created, ID: ${sent.id}`) ], ephemeral: true };
    }
}
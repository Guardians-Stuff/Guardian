...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if(!guild.verification.enabled) interaction.reply({ embeds: [ EmbedGenerator.errorEmbed('This guild doesn\'t have the Verification system enabled.') ], ephemeral: true });
        if(guild.verification.version != 'button') interaction.reply({ embeds: [ EmbedGenerator.errorEmbed('This guild uses a command for verification.') ], ephemeral: true });
